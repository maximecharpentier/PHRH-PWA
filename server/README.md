...
## Insertions données réelles
  ...
  3) Editer le fichier ./server/**.env** à votre convenance pour l'insertion :
  ...
  4) Lancer le serveur express : **node server**
  5) Les données vont s'inserer, patientez jusqu'a la fin du chargement ~2min chez moi
  6) Metez la configuration de votre **.env** de nouveau a jour pour eviter :
